...
**2026-09-22追記:** 以下は当時の不合格と修正方針の記録です。後続修正版の版付きJARで、単独inspect、14スタック896個のtake後の再inspectとstoreが成功しました。[rc.3公開前検証](20260922_release_rc3.md)を参照してください。旧失敗版の判定や登録接続の認証結果を書き換えるものではありません。
