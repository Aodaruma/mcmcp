...
class CraftAgentOutputSchemaContractTest {
    ...
    private static Map<String, Object> listRoutinesData() {
        return Map.of(
                "catalog_version", "phase-2",
                "routines", List.of(McpTestFixtures.fields(
                        "kind", "stationary_break",
                        "phase", 2,
                        "experimental", false,
                        "input_schema", McpToolSchemas.startRoutineInput(),
                        "postconditions", List.of("Inventory goal is server-confirmed."))));
    }
