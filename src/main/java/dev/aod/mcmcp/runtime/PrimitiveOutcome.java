...
record PrimitiveOutcome(boolean complete, AgentActionStore.Failure failure) {
    static PrimitiveOutcome running() { return new PrimitiveOutcome(false, null); }
    static PrimitiveOutcome succeeded() { return new PrimitiveOutcome(true, null); }
    static PrimitiveOutcome failed(AgentActionStore.FailureCode code, boolean recoverable,
        ...
        return new PrimitiveOutcome(false,
                new AgentActionStore.Failure(code, recoverable, details));
    }
}
