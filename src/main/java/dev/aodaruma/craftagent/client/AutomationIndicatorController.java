...
import dev.aodaruma.craftagent.runtime.AutomationUiSnapshot;
...
public final class AutomationIndicatorController {
    ...
    public AutomationIndicatorController(CraftAgentRuntime runtime) {
    ...
    private static Component label(AutomationUiSnapshot.State state, boolean confirming) {
        if (confirming) {
            return Component.translatable("gui.craftagent.automation.confirm_enable")
                    .withStyle(ChatFormatting.YELLOW);
        }
        return switch (state) {
            case ACTIVE -> Component.translatable("gui.craftagent.automation.active")
                    .withStyle(ChatFormatting.GREEN);
            case IDLE -> Component.translatable("gui.craftagent.automation.idle")
                    .withStyle(ChatFormatting.YELLOW);
            case DISABLED -> Component.translatable("gui.craftagent.automation.disabled")
    ...
    private static Component tooltip(AutomationUiSnapshot.State state, boolean confirming) {
        if (confirming) {
            return Component.translatable("gui.craftagent.automation.tooltip.confirm_enable");
        }
        return switch (state) {
            case ACTIVE, IDLE ->
                    Component.translatable("gui.craftagent.automation.tooltip.disable");
            case DISABLED ->
                    Component.translatable("gui.craftagent.automation.tooltip.enable");
        };
    }
