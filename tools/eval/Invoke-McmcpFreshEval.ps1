...
$ExpectedCatalogFileSha256 = '469ec6f55027ed35f7bdc075fea367fde62fecd0a9935a1f6a66aa643399c016'
$ExpectedToolSurfaceSha256 = 'a59e66bdce2a5b6dad5f7d3016ca8c91f78408345baa74890db4cf7747868e87'
$AllowedTools = @(
    'agent_get_state',
...
function Get-McpMeta {
    return [ordered]@{
        ...
        'io.modelcontextprotocol/clientInfo' = [ordered]@{
            name = 'mcmcp-fresh-eval-dynamic-bridge'
            version = '1'
        }
    }
}
...
function Assert-McmcpServerMeta {
    ...
    if (-not (Test-IsObjectValue $serverInfo) -or
        (Get-PropertyValue $serverInfo 'name') -cne $ExpectedMcmcpServerName -or
        (Get-PropertyValue $serverInfo 'version') -cne $ExpectedMcmcpServerVersion) {
